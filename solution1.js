...
function parseIntoStr (inputString) {
  let strArr = inputString.replace('+', '').split(', ')
...
const inputs = parseIntoStr(innerText);

const inputTest1 = [1,-1]
const inputTest2 = [3,3,4,-2,-4]
const inputTest3 = [-6,3,8,5,-6]
const inputTest4 = [7,7,-2,-7,-4]

function findChange(inputs) {
  let hist = {0:1}
  let found = false
  let curr = 0
  let i = 0
